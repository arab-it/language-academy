...
import '../widgets/smart_review/smart_review_card.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _smartReviewSummary() {
    final words = vocabularyWords
        .map((word) => word.english)
        .toSet()
        .toList();

    final practice = SmartReviewService.getCategoryCount(
      words,
      'Need Practice',
    );

    final review = SmartReviewService.getCategoryCount(
      words,
      'Need Review',
    );

    final mastered = SmartReviewService.getCategoryCount(
      words,
      'Almost Mastered',
    );
    return Material(
      ...
      child: InkWell(
        onTap: () => _open(const SmartReviewPage()),
        borderRadius: BorderRadius.circular(24),
        child: Padding(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () => _open(const SmartReviewPage()),
                  style: ElevatedButton.styleFrom(
